...
# train, test = None, None     # Your code here     # CHECK WHY "NONE, NONE"
...
preds = inference(model, X_test) # your code here   #CHECK if correct dataset (X_test?)

# Calculate and print the metrics
p, r, fb = compute_model_metrics(y_test, preds)
print(f"Precision: {p:.4f} | Recall: {r:.4f} | F1: {fb:.4f}")

# DONE: compute the performance on model slices using the performance_on_categorical_slice function
